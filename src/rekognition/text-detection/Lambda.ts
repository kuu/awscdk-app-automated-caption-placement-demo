...
export class Lambda extends Construct {
  ...
  constructor(scope: Construct, id: string, {
    ...
    // Create Lambda functions for text detection
    this.startFunc = new NodejsFunction(scope, `StartTextRekognitionFunction${id}`, {
    ...
    this.pollFunc = new NodejsFunction(scope, `PollTextRekognitionFunction${id}`, {
      runtime: Runtime.NODEJS_18_X,
    ...
    this.getFunc = new NodejsFunction(scope, `GetTextRekognitionFunction${id}`, {
      runtime: Runtime.NODEJS_18_X,
